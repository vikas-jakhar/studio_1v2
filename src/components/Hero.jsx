...
const Hero = () => {
    return (
        <div className=' bg-hero bg-cover bg-no-repeat bg-center min-h-screen lg:min-h-[810px] flex items-center relative'>
            <div className="container mt-10 py-10 relative z-[1]">
                <div className=" flex flex-col-reverse md:flex-row items-center pt-10 justify-between">
                    <div className=" flex flex-col justify-center max-w-[492px] items-center md:items-start w-full md:w-1/2 mt-6 md:mt-0">
                    ...
                    <div className=" max-w-[513px] w-8/12 md:w-1/2">
