...
const Impact = () => {
    return (
        <div className=' relative pt-2.5 pb-5 -mt-5 lg:py-16 xl:py-0 xl:min-h-[746px] bg-black bg-impact bg-cover bg-no-repeat' id='impact'>
            ...
            <div className="container pt-10 sm:pt-24 relative z-[1]">
                <div className=" mt-4 flex items-center gap-8 sm:gap-14 xl:gap-9 lg:gap-5 justify-center xl:justify-start flex-wrap lg:flex-nowrap">
                    ...
                    <img src={impact_dino} alt="impact_dino" className=' max-w-[445px] w-[40%] xl:w-full' data-aos="zoom-in" data-aos-duration="1500" />
