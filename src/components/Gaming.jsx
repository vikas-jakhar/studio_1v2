        ...
        <div className='xl:py-[71px] pt-10 sm:pt-16 pb-2 bg-black -mt-px relative' id='about'>
            <div className="container sm:pt-24 xl:pb-24 pt-10 relative z-[2]">
                <div className=" flex lg:flex-row flex-col items-center lg:justify-between xl:pt-2 gap-10">
                    ...
                    <div className="max-w-[535px] w-full flex flex-col justify-center items-center lg:items-start mt-3 sm:mt-6 lg:-mt-5" data-aos="fade-left" data-aos-duration="1500">
                        ...
                        <p className='font-poppins text-center lg:text-left font-normal text-lg text-white opacity-70 mt-9'>
