...
export const TEAM_DATA = [
    { id: 1, imgSrc: lava_land, altText: 'lava_land', blue_text: " Founder & Creative Director", heading: "John Doe", text: "John, 1v2 Studio's visionary, ensures innovative, engaging games with his decade-long expertise." },
    { id: 2, imgSrc: maze, altText: 'maze', blue_text: "Lead Developer", heading: "Jane Smith", text: "Jane's programming expertise turns creative concepts into engaging, playable experiences." },
    { id: 3, imgSrc: dino_island, altText: 'dino_island', blue_text: "Art Director", heading: "Alex Johnson", text: "Alex's visuals and animation expertise make our games visually stunning and cohesive." },
    { id: 4, imgSrc: cat_washing, altText: 'cat_washing', blue_text: "Community Manager", heading: "Emily Davis", text: "Emily connects us with players, managing social media and gathering valuable feedback." },
    { id: 5, imgSrc: fireplace, altText: 'fireplace', blue_text: "Sound Designer", heading: "Michael Brown", text: "Michael's sound design expertise adds depth and emotion to our games." },
];
