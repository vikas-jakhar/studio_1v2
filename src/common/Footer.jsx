    ...
    return (
        <div className='bg-footer bg-cover bg-no-repeat sm:pt-10 md:pt-20 py-2 -mt-1 bg-black relative' id='footer'>
            <div className="container mt-12 pt-1.5 flex-col flex items-center pb-10 relative z-[1]">
                <div className="mt-px px-3 relative bg-newsletter bg-100 bg-no-repeat max-w-[900px] w-full min-h-[317px] flex flex-col items-center py-11">
                    <p className=' text-white font-bold text-3xl sm:text-42 font-orbitron text-center sm:leading-[53px] md:leading-[63px]'>Subscribe to <span className=' relative py-0.5 pr-4'> <img src={red_line} alt="red_line" className=' absolute w-full top-1 -left-2 hidden lg:flex' />our newsletter</span></p>
